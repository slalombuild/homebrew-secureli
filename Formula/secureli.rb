class Secureli < Formula
    ...
    url "https://github.com/slalombuild/secureli/releases/download/v0.3.9/secureli-0.3.9.tar.gz"
    version "0.3.9"
    sha256 "7b6232a583585e9da575206d1b2f2db1cc63614333455d1f16c7202a595b18a7"
    license "Apache-2.0"
