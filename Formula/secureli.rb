class Secureli < Formula
    ...
    url "https://github.com/slalombuild/secureli/releases/download/v0.4.0/secureli-0.4.0.tar.gz"
    version "0.4.0"
    sha256 "e6b5c2eb3ac029aae5a2fce99936f017c7d59750a1843f52dd7f4e500f05c3a9"
    license "Apache-2.0"
