class Secureli < Formula
    ...
    url "https://github.com/slalombuild/secureli/releases/download/v0.6.7/secureli-0.6.7.tar.gz"
    version "0.6.7"
    sha256 "1f15d9737ed58b3951f82696d8882943a34be41062f9b07735d9bdd08930315c"
    license "Apache-2.0"
