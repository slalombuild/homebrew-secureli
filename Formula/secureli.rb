class Secureli < Formula
    ...
    url "https://github.com/slalombuild/secureli/releases/download/v0.4.4/secureli-0.4.4.tar.gz"
    version "0.4.4"
    sha256 "6b8164611c537e9a66db65cb7f1ab48178e0d718aab1ab1080856126eff26dac"
    license "Apache-2.0"
