class Secureli < Formula
    ...
    url "https://github.com/slalombuild/secureli/releases/download/v0.3.3/secureli-0.3.3.tar.gz"
    version "0.3.3"
    sha256 "15e1427edfa276c281b4e5f1becb4df585aafd47df6826d6c7d5b9defb7efce0"
    license "Apache-2.0"
