...
class Secureli < Formula
    ...
    url "https://github.com/slalombuild/homebrew-secureli/releases/download/v0.2.0/secureli-0.2.0.tar.gz", :using => GitHubPrivateRepositoryReleaseDownloadStrategy
    version "0.2.0"
    sha256 ""
