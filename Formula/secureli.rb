class Secureli < Formula
    ...
    url "https://github.com/slalombuild/secureli/releases/download/v0.6.0/secureli-0.6.0.tar.gz"
    version "0.6.0"
    sha256 "a0da034b58eabeda0b01151cf3259018b9cd9c58407f54e1d4131247de4fde88"
    license "Apache-2.0"
