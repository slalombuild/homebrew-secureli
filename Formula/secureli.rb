class Secureli < Formula
    ...
    url "https://github.com/slalombuild/secureli/releases/download/v0.5.1/secureli-0.5.1.tar.gz"
    version "0.5.1"
    sha256 "5a62fa560ee7acf1e6d216f5e3ac75d5216aab087406536516e8ccdf495c90eb"
    license "Apache-2.0"
