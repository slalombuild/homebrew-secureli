class Secureli < Formula
    ...
    url "https://github.com/slalombuild/secureli/releases/download/v0.4.5/secureli-0.4.5.tar.gz"
    version "0.4.5"
    sha256 "a9c640b2b7d4f2fbac1d0d2ffaa178fad7410318c17bc5a9e89773cfc7eb2eb1"
    license "Apache-2.0"
