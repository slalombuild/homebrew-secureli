class Secureli < Formula
    ...
    url "https://github.com/slalombuild/secureli/releases/download/v0.4.3/secureli-0.4.3.tar.gz"
    version "0.4.3"
    sha256 "4320077fa5a5d29786a09961900a447afe707e013858d1b7bb598b07ec03f672"
    license "Apache-2.0"
