...
class Secureli < Formula
    ...
    url "https://github.com/slalombuild/secureli/releases/download/v0.2.5/secureli-0.2.5.tar.gz", :using => GitHubPrivateRepositoryReleaseDownloadStrategy
    version "0.2.5"
    sha256 "80b844c41d1a53f1bfc7b4be4bf9b06d1f87c4d301c50ececa4498ee59ab3b1a"
