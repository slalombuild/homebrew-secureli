...
class Secureli < Formula
    ...
    url "https://github.com/slalombuild/homebrew-secureli/releases/download/v0.1.6/secureli-0.1.6.tar.gz", :using => GitHubPrivateRepositoryReleaseDownloadStrategy
    version "0.1.6"
    sha256 ""
