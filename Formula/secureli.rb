class Secureli < Formula
    ...
    url "https://github.com/slalombuild/secureli/releases/download/v0.6.6/secureli-0.6.6.tar.gz"
    version "0.6.6"
    sha256 "f40374bfa56cee8528908b30928e33836128eebe6c38903a821951f99860fceb"
    license "Apache-2.0"
